...
<div class="edd-bk-session-picker-msg edd-bk-session-picker-session-unavailable">
    <?php
        printf(
            __('Your chosen session is unavailable. It may have been booked by someone else. If you believe this is a mistake, please contact the site administrator.', 'eddbk')
        );
    ?>
</div>
