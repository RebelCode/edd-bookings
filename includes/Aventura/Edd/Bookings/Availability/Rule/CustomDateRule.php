...
/**
 * Description of CustomDateRule
 *
 * @author Miguel Muscat <miguelmuscat93@gmail.com>
 */
class CustomDateRule extends DateTimeRangeRule implements SessionRuleInterface
{
    ...
    public function generateSessionsForRange(PeriodInterface $range, Duration $duration)
    {
        ...
        $current = new Period($start->copy()->plus($this->getLower()->getTime()), $duration);
